...
export function TrainerCard() {
  return (
    ...
    >
      ...
      <div className="p-6 md:p-8 grid grid-cols-[auto_1fr] gap-6 items-start">
        {/* Avatar */}
        <div
          className="w-20 h-20 md:w-24 md:h-24 bg-red flex items-center justify-center font-display text-bone select-none"
          style={{
            fontSize: "3.5rem",
        ...
        {/* Identity */}
        <div className="font-mono text-ui min-w-0">
          <h2
            id="trainer-card-heading"
            className="font-display text-fg leading-none truncate"
      ...
      {/* Divider */}
      <div className="border-t border-line/40 mx-6 md:mx-8" />
      ...
      {/* Bio quote */}
      <div className="border-t border-line/40 mx-6 md:mx-8" />
      <p className="p-6 md:p-8 font-mono text-ui text-muted italic">
        “{profile.bio}”
      </p>
    </section>
  )
